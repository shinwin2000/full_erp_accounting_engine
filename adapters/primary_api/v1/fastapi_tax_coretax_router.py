...
async def get_tax_service(request: Request) -> Any:
    ...
    return await container.resolve_async(TaxService)
...
async def get_coretax_service(request: Request) -> Any:
    ...
    container = request.app.state.container
    return await container.resolve_async(CoretaxService)
...
async def get_coretax_bulk_use_case(request: Request) -> Any:
    ...
    container = request.app.state.container
    return await container.resolve_async(CoretaxBulkSubmissionUseCase)
