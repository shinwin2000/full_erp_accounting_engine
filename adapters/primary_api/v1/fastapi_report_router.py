...
async def get_report_service(request: Request) -> Any:
    ...
    return await container.resolve_async(ReportService)
...
async def get_report_scheduler(request: Request) -> Any:
    ...
    container = request.app.state.container
    return await container.resolve_async(ReportScheduler)
...
async def get_report_distributor(request: Request) -> Any:
    ...
    container = request.app.state.container
    return await container.resolve_async(ReportDistributor)
