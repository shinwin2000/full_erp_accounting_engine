...
from adapters.primary_api.v1.fastapi_currency_exchange_router import router as currency_exchange_router
...
from adapters.primary_api.v1.fastapi_intangible_asset_router import router as intangible_asset_router
