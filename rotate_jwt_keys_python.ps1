...
# 1. Backup key lama (buat referensi forensik, jangan dipakai lagi)
...
# 2. Generate key pair baru (2048-bit RSA, sesuai algorithm RS256) pakai Python cryptography
$pythonScript = @'
...
print("Key pair baru berhasil ditulis.")
'@

$pythonScript | python -

if ($LASTEXITCODE -ne 0) {
    Write-Host "GAGAL generate key - cek error python di atas" -ForegroundColor Red
    exit 1
}
