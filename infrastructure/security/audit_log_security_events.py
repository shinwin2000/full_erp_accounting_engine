...
class SecurityEventType(Enum):
    ...
    LOGOUT = "logout"
    PW_CHANGE = "password_change"          # sebelumnya PASSWORD_CHANGE
    PW_RESET = "password_reset"            # sebelumnya PASSWORD_RESET
    ...
    def display_name(self) -> str:
        names = {
            ...
            SecurityEventType.PW_CHANGE: "Ubah Password",
            SecurityEventType.PW_RESET: "Reset Password",
    ...
    def log(
        ...
        if self._enable_hash_chain:
            with self._lock:
                ...
                self._last_hash = event["hash"]  # type: ignore[assignment]
