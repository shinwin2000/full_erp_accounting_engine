...
class ARInvoiceLineTable(Base):
    ...
    invoice_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=True), ForeignKey("ar_invoice.id", ondelete="CASCADE"), nullable=False
    )
    ...
    invoice: Mapped[ARInvoiceTable] = relationship("ARInvoiceTable", back_populates="lines")
