...
Responsibility: Mendefinisikan model SQLAlchemy untuk tabel bill_of_materials.
               Tabel ini menyimpan Bill of Materials (BOM) untuk produk manufaktur,
               termasuk komponen, kuantitas, dan status.
Dependencies:
...
class BillOfMaterialsTable(Base, TimestampMixin, SoftDeleteMixin, VersionMixin, LegalEntityMixin):
    ...
    # Relationships (gunakan string untuk type hint dan relationship)
