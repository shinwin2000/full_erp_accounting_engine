...
def upgrade() -> None:
    ...
    op.alter_column('coretax_bupot', 'bupot_type',
               ...
               type_=sa.Enum('PPH21', 'PPH23', 'PPH26', 'PPH4_AYAT2', 'PPH_FINAL_LAIN', name='bupottype'),
               nullable=False)
    op.alter_column('coretax_bupot', 'status',
               existing_type=sa.VARCHAR(length=9),
               type_=sa.Enum('DRAFT', 'SUBMITTED', 'APPROVED', 'REJECTED', 'VOID', name='bupotstatus'),
               nullable=False)
    ...
    op.alter_column('coretax_nsfp', 'status',
               existing_type=sa.VARCHAR(length=20),
               server_default=None,
               type_=sa.Enum('ACTIVE', 'PARTIALLY_USED', 'EXHAUSTED', 'EXPIRED', 'CANCELLED', name='nsfstatus'),
               existing_nullable=False)
    ...
    op.alter_column('intangible_asset', 'asset_type',
               ...
               type_=sa.Enum('PATENT', 'TRADEMARK', 'COPYRIGHT', 'SOFTWARE', 'LICENSE', 'GOODWILL', 'CUSTOMER_RELATIONSHIP', 'OTHER', name='intangibleassettype'),
               nullable=False)
    ...
    op.alter_column('intangible_asset', 'amortization_method',
               existing_type=sa.VARCHAR(length=25),
               server_default=None,
               type_=sa.Enum('STRAIGHT_LINE', 'DECLINING_BALANCE', 'UNITS_OF_PRODUCTION', name='amortizationmethod'),
               existing_nullable=False)
