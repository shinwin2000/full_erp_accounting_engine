...
# =============================================================================
# FALLBACK FOR PTKPStatus IN CASE IMPORT FAILS
# =============================================================================
...
try:
    ...
    # Fallback: define PTKPStatus as an Enum with TK0 (minimum)
    class PTKPStatus(Enum):
        TK0 = "TK0"
        # Add other statuses if needed, but test only uses TK0
        TK1 = "TK1"
        # For completeness, we'll add all common statuses
        K0 = "K0"
        K1 = "K1"
        K2 = "K2"
        K3 = "K3"
    ...
    # Define a minimal EmployeePTKPStatusVO that matches test expectations
