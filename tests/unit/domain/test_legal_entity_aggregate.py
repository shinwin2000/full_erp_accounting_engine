...
# Helper untuk membuat Percentage
def pct(value: float) -> Percentage:
                                    ...
                                    def test_update_company_info(
                                        ...
                                        def test_deactivate_legal_entity(
                                            ...
                                            def test_cannot_deactivate_already_inactive(
                                                ...
                                                assert (
                                                    suspended.status == LegalEntityStatus.SUSPENDED
                                                )
                                                dissolved = suspended.dissolve(
                                                    "admin", datetime.now(UTC)
                                                )
                                                assert (
                                                    dissolved.status == LegalEntityStatus.DISSOLVED
                                                )
                                                with pytest.raises(
                                                    ValueError,
                                                    ...
                                                    with pytest.raises(
                                                        ...
                                                        def test_update_tax_profile(
                                                            ...
                                                            assert (
                                                                updated.tax_profile.tax_regime
                                                                == TaxRegime.FINAL
                                                            )
                                                            assert (
                                                                updated.tax_profile.corporate_income_tax_rate.value
                                                                == Decimal("0.5")
                                                            )
                                                            assert (
                                                                updated.version
                                                            ...
                                                            def test_legal_entity_id_is_uuid(
                                                                ...
                                                                def test_version_increments_on_update(
                                                                    ...
                                                                    entity = LegalEntity(**data)
                                                                    assert entity.version == 1
                                                                    entity2 = entity.suspend(
                                                                        "admin", "Test"
                                                                    )
                                                                    assert entity2.version == 2
                                                                    entity3 = entity2.reactivate(
                                                                        "admin", "Reactivate"
                                                                    )
                                                                    assert entity3.version == 3
                                                                    entity4 = (
                                                                        entity3.update_tax_profile(
                                                                            valid_tax_profile,
                                                                            "admin",
                                                                        )
                                                                    )
                                                                                ...
                                                                                with pytest.raises(
                                                                                    ...
                                                                                    def test_factory_method_reconstruct(
                                                                                        ...
                                                                                        def test_domain_events_creation(
                                                                                            ...
                                                                                            assert (
                                                                                                event_created.event_type.value
                                                                                                == "legal_entity_created"
                                                                                            )
                                                                                            assert (
                                                                                                event_created.legal_entity_id
                                                                                                == legal_entity_id
                                                                                            )
