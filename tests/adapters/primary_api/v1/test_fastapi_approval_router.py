# adapters/primary_api/v1/test_fastapi_approval_router.py
"""
...
def mock_approval_service():
    ...
    # Base approval request response
    def create_mock_request(**kwargs):
        defaults = {
            ...
            "entity_type": "journal",
            "entity_id": uuid4(),
            "entity_reference": "JRN-2025-001",
            "amount": Decimal("1000000"),
            "status": "pending",
            "current_level": "level_1",
            "requester_id": uuid4(),
            "requester_name": "Requester A",
            "requester_notes": "Test note",
            ...
            "approval_matrix_name": "Standard Matrix",
    ...
    svc.submit_approval.return_value = create_mock_request()
    svc.get_approval_request.return_value = create_mock_request()
    svc.get_approval_request_by_number.return_value = create_mock_request()
    svc.recall_approval.return_value = create_mock_request(status="cancelled")
    svc.cancel_approval.return_value = create_mock_request(status="cancelled")
    svc.process_approval_action.return_value = create_mock_request(status="approved")
    svc.list_approval_requests.return_value = MagicMock(
        items=[create_mock_request()],
        total=1,
    )
    ...
    # Matrix responses
    svc.create_approval_matrix.return_value = MagicMock(
        id=uuid4(),
        matrix_code="MAT-001",
    ...
    svc.get_approval_matrix.return_value = svc.create_approval_matrix.return_value
    svc.list_approval_matrices.return_value = [svc.create_approval_matrix.return_value]
    svc.update_approval_matrix.return_value = svc.create_approval_matrix.return_value
    ...
    # Delegation
    svc.create_delegation.return_value = MagicMock(
        id=uuid4(),
        delegator_id=uuid4(),
    ...
    svc.list_delegations.return_value = [svc.create_delegation.return_value]
    svc.revoke_delegation.return_value = MagicMock(is_active=False)

    # Statistics
    svc.get_approval_statistics.return_value = MagicMock(
        total_requests=100,
        pending_requests=20,
    ...
    # Entity status
    svc.get_entity_approval_status.return_value = create_mock_request()
...
class TestSubmitApproval:
    async def test_submit_success(self, mock_approval_service, mock_token_payload, mock_legal_entity_id):
    ...
    async def test_submit_value_error(self, mock_approval_service, mock_token_payload, mock_legal_entity_id):
        mock_approval_service.submit_approval.side_effect = ValueError("Invalid entity")
        request = ApprovalRequestCreateSchema(
            entity_type=ApprovalEntityType.JOURNAL,
            entity_id=uuid4(),
        )
    ...
    async def test_submit_permission_error(self, mock_approval_service, mock_token_payload, mock_legal_entity_id):
        mock_approval_service.submit_approval.side_effect = PermissionError("Not allowed")
        request = ApprovalRequestCreateSchema(
            entity_type=ApprovalEntityType.JOURNAL,
            entity_id=uuid4(),
        )
...
class TestRecallApproval:
    async def test_recall_success(self, mock_approval_service, mock_token_payload, mock_legal_entity_id):
        req_id = uuid4()
    ...
    async def test_recall_not_found(self, mock_approval_service, mock_token_payload, mock_legal_entity_id):
...
class TestCancelApproval:
    async def test_cancel_success(self, mock_approval_service, mock_token_payload, mock_legal_entity_id):
        req_id = uuid4()
    ...
    async def test_cancel_not_found(self, mock_approval_service, mock_token_payload, mock_legal_entity_id):
    ...
    async def test_cancel_permission_error(self, mock_approval_service, mock_token_payload, mock_legal_entity_id):
...
class TestPerformApprovalAction:
    async def test_approve_success(self, mock_approval_service, mock_token_payload, mock_legal_entity_id):
        req_id = uuid4()
    ...
    async def test_escalate_success(self, mock_approval_service, mock_token_payload, mock_legal_entity_id):
        req_id = uuid4()
    ...
    async def test_delegate_success(self, mock_approval_service, mock_token_payload, mock_legal_entity_id):
        req_id = uuid4()
        delegate_user = uuid4()
        action_data = ApprovalActionSchema(
    ...
    async def test_action_not_found(self, mock_approval_service, mock_token_payload, mock_legal_entity_id):
    ...
    async def test_action_value_error(self, mock_approval_service, mock_token_payload, mock_legal_entity_id):
        mock_approval_service.process_approval_action.side_effect = ValueError("Invalid action")
        action_data = ApprovalActionSchema(action=ApprovalAction.APPROVE)
        with pytest.raises(HTTPException) as exc:
            await perform_approval_action(
                request_id=uuid4(),
...
class TestApproverTasks:
    async def test_get_my_tasks(self, mock_approval_service, mock_token_payload, mock_legal_entity_id):
    ...
    async def test_get_tasks_count(self, mock_approval_service, mock_token_payload, mock_legal_entity_id):
...
class TestApprovalMatrixCRUD:
    async def test_create_matrix_success(self, mock_approval_service, mock_token_payload, mock_legal_entity_id):
    ...
    async def test_update_matrix_success(self, mock_approval_service, mock_token_payload, mock_legal_entity_id):
        matrix_id = uuid4()
    ...
    async def test_delete_matrix_deactivate(self, mock_approval_service, mock_token_payload, mock_legal_entity_id):
        matrix_id = uuid4()
    ...
    async def test_delete_matrix_permanent(self, mock_approval_service, mock_token_payload, mock_legal_entity_id):
        matrix_id = uuid4()
        result = await delete_approval_matrix(
            matrix_id=matrix_id,
            permanent=True,
...
class TestDelegation:
    ...
    async def test_list_delegations(self, mock_approval_service, mock_token_payload, mock_legal_entity_id):
    ...
    async def test_revoke_delegation_success(self, mock_approval_service, mock_token_payload, mock_legal_entity_id):
        del_id = uuid4()
    ...
    async def test_revoke_delegation_not_found(self, mock_approval_service, mock_token_payload, mock_legal_entity_id):
...
class TestStatisticsAndStatus:
    ...
    async def test_get_entity_approval_status_found(self, mock_approval_service, mock_legal_entity_id):
        entity_id = uuid4()
    ...
    async def test_get_entity_approval_status_not_found(self, mock_approval_service, mock_legal_entity_id):
