# AUTO-GENERATED TESTS for compliance/legal/sanction_list_checker.py
# =========================================
# Regenerated by gen_tests.py (AST-based, real code)
# Source module: compliance.legal.sanction_list_checker
...
from compliance.legal.sanction_list_checker import (
    SanctionCheckResult,
    SanctionListChecker,
    SanctionListEntry,
)
